...
//echo '<pre>' . print_r($role,false) . '</pre>';
...
<div class="container">
    <div class="row">
        <div class="col-md-3 bg-sidebar">
            ...
            <?php if (isset($role['superAdmin']) || (Yii::$app->user->can('update_page') && Yii::$app->user->can('update_page_chamber'))): ?>
            ...
            <div class="list-group my-3">
                ...
                <?php if (isset($role['superAdmin']) || (Yii::$app->user->can('update_page_chamber') && Yii::$app->user->can('create_subPage'))): ?>
